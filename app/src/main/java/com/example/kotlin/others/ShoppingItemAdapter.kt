...
import com.example.kotlin.data.db.entities.ShoppingItem
import com.example.kotlin.ui.shoppinglist.ShoppingViewModel
...
class ShoppingItemAdapter(
    ...
    override fun onBindViewHolder(holder: ShoppingViewHolder, position: Int) {
        ...
        holder.itemView.ivDelete.setOnClickListener { viewModel.delete(currShoppingItem) }
